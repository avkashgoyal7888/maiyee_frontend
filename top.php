...
<div class="notification-bar mobilehide">
    <a href="#" class="notification-bar__message">20% off your very first purchase, use promo code: MAIYEE</a>
...
<div class="search">
    <div class="search__form">
        <form class="search-bar__form" action="#">
            ...
            <input class="search__input" type="search" placeholder="Search entire store..." aria-label="Search" autocomplete="off">
        </form>
...
<!--------Desktop Menu--------->
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-block d-lg-none mobile-logo">
                	<div class="logo">
                        <a href="index.html"><img src="assets/images/logo1.png" height="50px" width="100px"></a>
                    </div>
                </div>
                <!--Mobile Logo-->
